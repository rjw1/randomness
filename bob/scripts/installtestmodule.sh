#!/usr/bin/bash
# script to add modules to my testing installs.
...
#clean up .cpan
rm -rf $HOME/cpantesting/perl-${PERL}/.cpan/*
# tar up new stuff.
gtar -zcf  $HOME/cpantesting/perl-${PERL}.tar.gz -C $HOME/cpantesting/ perl-${PERL}
done
